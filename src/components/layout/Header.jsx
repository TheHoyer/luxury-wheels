        ...
        <header className={styles.header}>
            <div className={styles.container}>
                ...
                <div className={styles.actions}>
                    <div className={styles.socialIcons}><a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook"><FaFacebookF /></a><a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><FaInstagram /></a><Link to="/contact" aria-label="Kontakt telefoniczny"><FaPhoneAlt /></Link></div>
                    <Link to="/booking/select-dates" className={styles.ctaButton}>Zarezerwuj</Link>
                </div>
            ...
            {isMobileMenuOpen && (
                <div className={styles.mobileNav}>
                    ...
                    <Link to="/booking/select-dates" className={styles.mobileCtaButton} onClick={closeMobileMenu}>
                        Zarezerwuj
                    </Link>
